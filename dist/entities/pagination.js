...
exports.PaginationVerifier = void 0;
class PaginationVerifier {
    constructor() { }
    static verifyIPagination(p) {
        if (!p)
            return false;
        if (!p.pageNumber)
            return false;
    ...
    static verifyIPaginatioWithDates(p) {
        if (!p)
            return false;
        if (!p.pageNumber)
            return false;
    ...
    static verifyIPaginatioWithDatesAndState(p) {
        if (!p)
            return false;
        if (!p.pageNumber)
            return false;
    ...
    static defaultPaginationExample() {
        return {
            description: 'This endpoint allows only a default pagination, this prop is not required',
            pageNumber: 'This prop is *required* and references the requested page',
            pageElements: 'This prop is *required* and references the maximun number of elements expected in the requested page',
        };
    }
    static paginationWithDatesExample() {
        return {
            ...
            pageNumber: 'This prop is *required* and references the requested page',
            pageElements: 'This prop is *required* and references the maximun number of elements expected in the requested page',
            start: 'This prop is *required* and references the start of the date range used to browse, should be in ISODate Format',
...
exports.PaginationVerifier = PaginationVerifier;
